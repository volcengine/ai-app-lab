#!/usr/bin/env python3
"""校验 standardize-chemical-structures 的 JSON 输出契约。"""
...
def load_output_contract() -> Any:
    path = Path(__file__).with_name("standardization_output_contract.py")
    spec = importlib.util.spec_from_file_location(
        "standardization_output_validator_contract",
        path,
    )
