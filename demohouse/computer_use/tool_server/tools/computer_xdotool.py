...
from .base import camel_to_snake, ignore_extra_kwargs
from .run import run
from .constants import KEYS, CLICK_BUTTONS, SCROLL_BUTTONS, SCREENSHOT_DIR
...
class XDOComputerTool(IComputerTool):
    ...
    @ignore_extra_kwargs
    async def shell(self, command: str) -> BaseResult:
