...
export const getDEFAULT_ERROR_MESSAGE = () =>
  'System abnormal, please contact customer service or try again';
...
export const getERROR_MESSAGE_BY_HTTP_CODE = (httpCode: number): string => {
  switch (httpCode) {
    case 400:
      return 'Illegal request parameter';
    case 403:
      return 'Unauthorized access';
    case 404:
      return 'Requested resource not found';
    case 500:
      return 'Internal server error, please contact customer service or try again';
    case 502:
      return 'Upstream service error';
    case 504:
      return 'Upstream service timeout';
    case ERequestErrorCode.NoResponse:
      return 'Current network is abnormal, please try again later';
    default:
