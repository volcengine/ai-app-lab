    ...
    setRenderedMessages(prevRenderedMessages => {
      ...
      if (newMessage.type === VideoGeneratorMessageType.Multiple) {
        ...
        if (
          ...
          lastRenderedMessage.type === VideoGeneratorMessageType.Multiple
        ) {
          // 更新消息
          return [
            ...prevRenderedMessages.slice(0, -1),
        ...
        // 解决前面是仅是 phase 的情况，把仅是 phase 的信息去掉
        if (lastRenderedMessage.type === VideoGeneratorMessageType.Text) {
          const textRenderedMessage = lastRenderedMessage as VideoGeneratorBotMessage;
          if (
            textRenderedMessage.versions[textRenderedMessage.currentVersion][1].logid ===
            phaseComplexMessage.versions[phaseComplexMessage.currentVersion][1].logid
          ) {
            // 更新消息
            return [
              ...prevRenderedMessages.slice(0, -1),
