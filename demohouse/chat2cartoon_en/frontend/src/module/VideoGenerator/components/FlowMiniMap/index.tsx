...
import { Button, Steps, Trigger } from '@arco-design/web-react';
...
export const StepsSection = () => (
  <Steps
    current={0}
    className={`${s.steps} rounded-md bg-white p-[10px]`}
    style={{ boxShadow: '0px 2px 6px 0px rgba(0, 0, 0, 0.05)' }}
    size="small"
    direction={'vertical'}
  >
    <Step className={s.icon} title={'Develop story concepts'} />
    <Step className={s.icon} title={'Generate storyboard'} />
    <Step className={s.icon} title={'Produce the final video'} />
  </Steps>
);
