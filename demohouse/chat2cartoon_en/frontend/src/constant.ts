...
enum EBotErrorType {
  RiskText = 'RiskText',
  ClientNetworkError = 'ClientNetworkError',
...
export const botErrorCodesMessageMap = {
  // 触发内容审核
  [ErrorCodes.ReqTextExistRisk]: 'The input text contains sensitive content. Please change the topic and try again.',
  [ErrorCodes.RespTextExistRisk]: 'The output text contains sensitive content. Please change the topic and try again.',
  ...
  [ErrorCodes.SensitiveContentDetected]:
    'The input text contains sensitive content. Please change the topic and try again.',
